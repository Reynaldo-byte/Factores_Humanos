...
<head>
    ...
    <title>OlympusSpa-Editar Trabajador</title>
    <link type="icon" href="Img/logo.png" />
    <link rel=StyleSheet HREF="../css/Agregar.css" type="text/css" media=screen>
</head>
<body>
    <header><h1>Editar Trabajador</h1></header>
    <?php
    include ("../php/Conexion.php");
    $id=$_GET['id'];
    $sql="select Tipo_Id,Num_id,Fecha_Nacimiento from trabajador where Id_Usuario=".$id;
    ...
    ?>
    <form action="../php/Admin/Editar_Trabajador.php" method="post" class="formulario">
        ...
        Telefono Fijo <input type="number" name="fixed_number" id="fixed_number" required/>
