...
<head>
    ...
    <title>OlympusSpa-Eliminar Gerente</title>
    <link type="icon" href="Img/logo.png" />
    <link rel=StyleSheet HREF="../css/Agregar.css" type="text/css" media=screen>
</head>
<body>
    <header><h1>Eliminar Gerente</h1></header>
    <?php
    include ("../php/Conexion.php");
    $id=$_GET['id'];
    $sql="select * from Administrador where Id_Usuario=".$id;
    ...
    ?>
    <form action="../php/Admin/Eliminar_Gerente.php" method="POST" class="formulario">
        ...
        <input type="submit" value="Eliminar" value="Eliminar" name="Registrar" id="Registrar"/>
    </form>
